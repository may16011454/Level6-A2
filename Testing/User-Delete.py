...
#Selenium code to delete a user 
...
delete_user_link = driver.find_element(By.XPATH, '/html/body/div/div/div[1]/div/div[2]/a')
delete_user_link.click()


# delete bottom user button
delete_button = driver.find_element(By.XPATH, '/html/body/div/table/tbody/tr[10]/td[5]/a[2]')
delete_button.click()
