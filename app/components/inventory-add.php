...
$categories = $controllers->categories(); // Add category controller
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $category_id = intval($_POST['category_id']); // Add category_id processing
    ...
    if ($valid) {
        ...
        $equipmentData = [
            ...
            'category_id' => $category_id, // Add category_id to equipment data
        ];
                        ...
                        <div class="card-body p-5 text-center">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="supplier" name="supplier_id">
                                    <?php foreach ($suppliers->get_all_suppliers() as $supplier) : ?>
